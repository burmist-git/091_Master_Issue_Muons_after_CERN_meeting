...
The DPPS shall be able to estimate and apply corrections for biases introduced by optical aberrations in the mapping from camera coordinates to incidence angle, using full geometry ray-tracing. The DPPS shall produce per-telescope correction maps and report residuals after correction. **(closed)**  **(The test statement needs to be written and approved.)**
...
The DPPS shall calculate alternative estimates of the optical PSF of each telescope from muon analysis and use these to monitor and improve the accuracy of the monitored optical PSF. **(closed)**  **(The test statement needs to be written and approved.)**

8) **From DPPS_LevelB_Requirements_Batch3_Calibration.xlsx:  B-DPPS-37XX Degradation of individual mirrors from muon analysis.**
The DPPS shall calculate alternative estimates of the relative reflectance of each mirror with respect to the telescope average from muon analysis. **(TBD)** __calibpipe__ or __ctapipe__  **(The test statement needs to be written and approved.)**
...
The DPPS shall make sure that biases introduced by pulse integration and noise removal to the muon analysis shall be smaller than 1% of the estimated ring image size. **(To clarify)** __calibpipe__  **(The test statement needs to be written and approved.)**
...
The DPPS shall exclude broken or masked pixels from the signal predictor of the muon image that is used to calculate the muon bandwidth. **(TBD)** __calibpipe__ or __ctapipe__  **(The test statement needs to be written and approved.)**
...
The DPPS shall use non-circularity of the reflectors from muon analysis following the prescriptions outlined in Section 3.4.2 ("Interpolation of Flat Mirror Distance")  [RD]. **(TBD in progress)** __ctapipe__  **(The test statement needs to be written and approved.)**
...
The DPPS shall be capable to estimate and correct for the bias on the reconstructed Cherenkov angle due to the effect of finite camera focuses for the  muon analysis using Eq. 45 of [RD]. **(TBD)** __ctapipe__  **(The test statement needs to be written and approved.)**

15)  **From DPPS_LevelB_Requirements_Batch3_Calibration.xlsx: B-DPPS-37XX Geomagnetic field effects for muon analysis.**
The DPPS shall be capable of taking into account the effect of bending of the muon trajectory due to geomagnetic field effects, and to ensure that their effects bias the estimated optical throughput from muon analysis by less than 1% rms in relative terms using Eqs. 49-51 of [RD]. **(TBD)** __ctapipe__  **(The test statement needs to be written and approved.)**

16)   **From DPPS_LevelB_Requirements_Batch3_Calibration.xlsx:  B-DPPS-37XX Shadow awareness for muon analysis.**
Impact distance reconstruction of the muon analysis shall include the effect of shadows from the camera and the central hole in the main reflector and the possible secondary mirror plus protecting baffles and particularly its dependency on the muon inclination. **(TBD)** __ctapipe__  **(The test statement needs to be written and approved.)**

17) **From DPPS_LevelB_Requirements_Batch3_Calibration.xlsx:  B-DPPS-37XX Secondary mirror awareness for muon analysis.**
Impact distance reconstruction of the muon analysis shall include the effect of a secondary mirror. **(TBD)** __ctapipe__  **(The test statement needs to be written and approved.)**

18) **From DPPS_LevelB_Requirements_Batch3_Calibration.xlsx:  B-DPPS-37XX Muon simulations.**
The muon analysis shall be calibrated at during commissioning of each new telescope against dedicated muon simulations, which shall correctly include all shadowing parts of the telescope, at their respective distances to the reflector. The residual rms systematic error of the simulated muon ring image pixel-wise sizes shall not exceed 1% of the one corresponding to the designed telescope. **(closed)**  **(The test statement needs to be written and approved.)**
...
The DPPS shall be capable to estimate and correct extinction of the muon Cherenkov light by aerosols in the air. **(TBD)** __calibpipe__  **(The test statement needs to be written and approved.)**
...
The DPPS shall be capable to include awareness of dependencies of the sensitivity of the camera to light inciding from angles onto the camera and correct for these. **(To clarify)** __calibpipe__ or __ctapipe__  **(The test statement needs to be written and approved.)**
...
Residual contributions to the estimated optical throughput from muon analysis shall not exceed 0.5% (LST) or 1%(MST) in relative terms.  This requirement does not apply to the muon analysis of SSTs. **(closed)**  **(The test statement needs to be written and approved.)**

22) **Optimize the computation by using photon energy instead of wavelength.**
This is related to the fact that Cherenkov light has a photon energy distribution that is flat with respect to wavelength (~1/lambda^2). **(TBD)** __ctapipe__  **(The test statement needs to be written and approved.)**
